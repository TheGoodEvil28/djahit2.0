document.addEventListener('DOMContentLoaded', function() {
            ...
            if (token) {
                ...
                .then(response => {
                    if (response.ok) {
                        ...
                        window.location.href = '../frontend/page/riwayatorder.html';
                        return;
                    }
            ...
            async function handleRegistration(formData) {
                try {
                    ...
                    if (response.ok && data.success) {
                        ...
                        setTimeout(() => {
                            window.location.href = '/frontend/page/login.html?success=registration_successful';
                        }, 2000);
            ...
            // Google registration handler (placeholder)
            const googleButton = document.querySelector('button[type="button"]');
            if (googleButton) {
                googleButton.addEventListener('click', function() {
                    showToast('Google registration coming soon!', 'error');
